...
public class BeanstalkApi {
     ...
     * @param numberPerPage optional - number of elements per page (default 30,
     * maximum 50)
     * @return all repositories
     */
    ...
    /**
     * Create permissions for user. Admin privileges required for this API
     * method.
     *
     * @param permission
     * @return
    ...
    /**
     * This method will return changesets from all repositories available to the
     ...
     * @param order order direction. Should be either ASC or DESC (default is
     * DESC).
     * @return
     */
