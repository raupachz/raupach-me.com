...
public class InvitationBuilder {
	...
	public InvitationBuilder(Element element) {
		this();
		...
		creatorEmail(DOMUtils.getChildText(element,"creator-email"));
		creatorId(DOMUtils.getChildText(element, "creator-id"));
		creatorName(DOMUtils.getChildText(element,"creator-name"));
		secureToken(DOMUtils.getChildText(element,"secure-token"));
